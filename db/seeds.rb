...
communal_item = CommunalItem.create(name: "Paper Towel", brand: "charmin", quantity: 12, house_id: 1, stock_level: "low")
message = user.messages.create(content: "You're the best!!", house_id: 1)
chore_issue = chore.issues.create(reason: "whatever", user_id: 1)
