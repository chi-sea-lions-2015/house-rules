...
chore2 = Chore.create(task: "Mop the floor", house_id: 1)
...
event_issue = event.issues.create(reason: "I hate halloween", creator: "Zach")
rule_issue = rule.issues.create(reason: "I hate flushing!!", creator: "Sara")
chore_promise_true = chore.user_promises.create(creator: "Paul", fulfilled: true)
chore_promise_false = chore.user_promises.create(creator: "Paul")
communal_item.user_promises.create(creator: "Paul")
communal_item.user_promises.create(creator: "Paul", fulfilled: true)
...
message2 = Message.create(content: "Love you!!!", house_id: 1, author: "Paul")
message3 = Message.create(content: "OMFG, You guys suck!", house_id: 1, author: "Paul")
